...
public class OrganizadorService {
    ...
    public OrganizadorDTO ativarComSenha(Long id, String senha) {
        ...
        if (organizador.getAtivo()) {
            throw new ConflictException("Organizador já está ativo");
        }
    ...
    public OrganizadorDTO desativarComSenha(Long id, String senha) {
        ...
        if (!organizador.getAtivo()) {
            throw new ConflictException("Organizador já está inativo");
        }
    ...
    private void validarDadosEmpresaOpcional(OrganizadorDTO dto) {
        ...
        if (dto.getCnpj() == null || dto.getCnpj().trim().isEmpty()) {
            throw new ValidationException("CNPJ é obrigatório quando a empresa for informada");
        }
        if (dto.getRazaoSocial() == null || dto.getRazaoSocial().trim().isEmpty()) {
            throw new ValidationException("Razão social é obrigatória quando a empresa for informada");
        }
        if (dto.getNomeFantasia() == null || dto.getNomeFantasia().trim().isEmpty()) {
            throw new ValidationException("Nome fantasia é obrigatório quando a empresa for informada");
        }
    }
